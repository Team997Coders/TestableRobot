...
package frc.robot.test.commandgroups;
...
import frc.robot.test.helpers.TestWithScheduler;
import frc.robot.test.mocks.DigitalOutputMock;

import static frc.robot.test.helpers.SchedulerPumpHelper.runForDuration;
